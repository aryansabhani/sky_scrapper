  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<WeatherProvider>(builder: (context, provider, _) {
      return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            Padding(
              ...
              child: IconButton(
                  onPressed: () {
                    provider.ChangeTheme(val: !provider.theme);
                  },
                  icon: (provider.theme)
        ...
        body: (provider.allday.isNotEmpty)
            ? Padding(
                    ...
                    children: [
                      TextField(
                        onSubmitted: (value) {
                          ...
                          provider.nextdayWeather(LocationName: value);
                          provider.allDayWeather(LocationName: value);
                        },
                      ...
                      Center(
                          child: Text(
                        "${provider.current?['location']['name']}"
                            .toUpperCase(),
                        style: TextStyle(
                          fontSize: 36,
